...
(use-package projectile
  ...
  (when (file-directory-p "/mnt/c/Users/rithar/MLPA")
    (add-to-list 'projectile-project-search-path "/mnt/c/Users/rithar/MLPA"))
  ;; (when (file-directory-p "/docker:go-devenv:/MLPA")
    ;; (add-to-list 'projectile-project-search-path "/docker:go-devenv:/MLPA"))
